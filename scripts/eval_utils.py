...
from ccdvaeplus.common.constants import CompScalerMeans, CompScalerStds
from ccdvaeplus.common.data_utils import StandardScaler, chemical_symbols
from ccdvaeplus.pl_data.dataset import TensorCrystDataset
from ccdvaeplus.pl_data.datamodule import worker_init_fn
...
def composition2atom_types(composition: Composition):
    return list(
        itertools.chain.from_iterable(
            [smact.Element(elem).number] * int(n) for elem, n in composition.items()
        )
    )